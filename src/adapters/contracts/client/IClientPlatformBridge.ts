...
export class IClientPlatformBridge {
  getLocalPlayerPed(): number { return 0 }
  getEntityCoords(_entity: number): Vector3 { return { x: 0, y: 0, z: 0 } }
  getWorldPositionOfEntityBone(_entity: number, _bone: number): Vector3 { return { x: 0, y: 0, z: 0 } }
  getGameplayCamCoords(): Vector3 { return { x: 0, y: 0, z: 0 } }
  ...
  isModelInCdimage(_hash: number): boolean { return false }
  isModelValid(_hash: number): boolean { return false }
  isModelAVehicle(_hash: number): boolean { return false }
  isModelAPed(_hash: number): boolean { return false }
  requestModel(_hash: number): void {}
  hasModelLoaded(_hash: number): boolean { return false }
  setModelAsNoLongerNeeded(_hash: number): void {}
  requestAnimDict(_dict: string): void {}
  hasAnimDictLoaded(_dict: string): boolean { return false }
  removeAnimDict(_dict: string): void {}
  requestNamedPtfxAsset(_asset: string): void {}
  hasNamedPtfxAssetLoaded(_asset: string): boolean { return false }
  removeNamedPtfxAsset(_asset: string): void {}
  useParticleFxAssetNextCall(_asset: string): void {}
  startParticleFxLoopedAtCoord(_effectName: string, _position: Vector3, _rotation: Vector3, _scale: number): number { return 0 }
  startParticleFxNonLoopedAtCoord(_effectName: string, _position: Vector3, _rotation: Vector3, _scale: number): number { return 0 }
  stopParticleFxLooped(_handle: number, _stop: boolean): void {}
  requestStreamedTextureDict(_dict: string, _persistent: boolean): void {}
  hasStreamedTextureDictLoaded(_dict: string): boolean { return false }
  setStreamedTextureDictAsNoLongerNeeded(_dict: string): void {}
  requestScriptAudioBank(_bank: string, _networked: boolean): boolean { return false }
  releaseScriptAudioBank(_bank: string): void {}
  doesEntityExist(_entity: number): boolean { return false }
  ...
  createPed(_pedType: number, _modelHash: number, _position: Vector3, _heading: number, _networked: boolean, _scriptHostPed: boolean): number { return 0 }
  deletePed(_ped: number): void {}
  createObject(_modelHash: number, _position: Vector3, _networked: boolean, _dynamic: boolean, _placeOnGround: boolean): number { return 0 }
  ...
  getPedBoneIndex(_ped: number, bone: number): number { return bone }
  ...
  getClosestPed(_position: Vector3, _radius: number): number | null { return null }
  getNearbyPeds(_position: Vector3, _radius: number, _excludeEntity?: number): number[] { return [] }
  ...
  createVehicle(_modelHash: number, _position: Vector3, _heading: number, _networked: boolean, _scriptHostVehicle: boolean): number { return 0 }
  deleteVehicle(_vehicle: number): void {}
  setVehicleOnGroundProperly(_vehicle: number): void {}
  getVehicleColours(_vehicle: number): [number, number] { return [0, 0] }
  ...
  getClosestVehicle(_position: Vector3, _radius: number): number | null { return null }
  isPedInAnyVehicle(_ped: number): boolean { return false }
  getVehiclePedIsIn(_ped: number, _lastVehicle: boolean): number | null { return null }
  getPedInVehicleSeat(_vehicle: number, _seatIndex: number): number | null { return null }
  getEntitySpeed(_entity: number): number { return 0 }
  networkGetNetworkIdFromEntity(_entity: number): number { return 0 }
  networkDoesEntityExistWithNetworkId(_networkId: number): boolean { return false }
  networkGetEntityFromNetworkId(_networkId: number): number { return 0 }
  getEntityHeading(_entity: number): number { return 0 }
  getEntityModel(_entity: number): number { return 0 }
  getVehicleNumberPlateText(_vehicle: number): string { return '' }
  ...
  getVehicleExtraColours(_vehicle: number): [number, number] { return [0, 0] }
  ...
  getVehicleFuelLevel(_vehicle: number): number { return 0 }
  ...
  getEntityMaxHealth(_entity: number): number { return 200 }
  setPedArmour(_ped: number, _armour: number): void {}
  isScreenFadedOut(): boolean { return false }
  isScreenFadingOut(): boolean { return false }
  doScreenFadeOut(_ms: number): void {}
  isScreenFadedIn(): boolean { return true }
  isScreenFadingIn(): boolean { return false }
  doScreenFadeIn(_ms: number): void {}
  networkIsSessionStarted(): boolean { return true }
  networkResurrectLocalPlayer(_position: Vector3, _heading: number): void {}
  playerId(): number { return 0 }
  setPlayerModel(_playerId: number, _modelHash: number): void {}
  requestCollisionAtCoord(_position: Vector3): void {}
  hasCollisionLoadedAroundEntity(_entity: number): boolean { return true }
  ...
  addBlipForCoord(_position: Vector3): number { return 0 }
  addBlipForEntity(_entity: number): number { return 0 }
  addBlipForRadius(_position: Vector3, _radius: number): number { return 0 }
  doesBlipExist(_handle: number): boolean { return false }
  ...
  endTextCommandThefeedPostMessagetext(_textureDict: string, _textureName: string, _flash: boolean, _iconType: number, _sender: string, _subject: string): void {}
  setNotificationBackgroundColor(_color: number): void {}
  setNotificationMessage(_textureDict: string, _textureName: string, _flash: boolean, _iconType: number, _title: string, _subtitle: string): void {}
  ...
  isControlJustPressed(_padIndex: number, _control: number): boolean { return false }
  ...
  createCam(_camName: string, _active: boolean): number { return 0 }
  ...
  onLocalPlayerStateChange(_key: string, _handler: (value: unknown) => void): () => void { return () => {} }
  getEntityState<T>(_entity: number, _key: string): T | undefined { return undefined }
}
